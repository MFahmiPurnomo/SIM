...
<!--circle chart-->
<script src="{{asset('admin/themes/js/circles.min.js')}}"></script>
<script>
...
<script src="{{asset('admin/themes/js/highcharts.js')}}"></script>
<script src="{{asset('admin/themes/js/highcharts-more.js')}}"></script>
...
<script type="text/javascript" language="javascript" src="{{ asset('admin/components/datetimepicker/js/moment-with-locales.js')}}"></script>
<script type="text/javascript" language="javascript" src="{{ asset('admin/components/datetimepicker/js/bootstrap-datetimepicker.js')}}"></script>
<script>
